...
module Savon
  class Header
    ...
    def initialize(globals, locals)
      ...
      @wsse_session   = locals[:wsse_session].nil? ? globals[:wsse_session] : locals[:wsse_session]
    ...
    attr_reader :local_header, :global_header, :gyoku_options,
                :wsse_auth, :wsse_timestamp, :wsse_signature, :wsse_session
    ...
    def akami
      ...
      wsse.session = wsse_session if wsse_session
